...
![img.png](images/typesale.png)<br>
![img.png](images/typerent.png)<br>
2. Фильтр по типу жилья работает корректно.
![img.png](images/typebuilding.png)<br>
3. Фильтр по кол-ву комнат работает корректно.
![img.png](images/countrooms.png)<br>
4. Фильтр по цене работает корректно.
![img.png](images/price.png)<br>
5. Фильтр по адресу работает корректно.
![img.png](images/address.png)<br>
6. Подсказка к полю "Адрес" при наведении подсвечивает всю область, хотя обработка стоит только на текст.
![img.png](images/address3.png)<br>
![img.png](images/address2.png)<br>
7. При нажатии на кнопку "Найти" все фильтры применяются корректно.
