...
3. Номер карты валидируется, проверяется количество символов.
4. Дата "Годен до" - ошибка о просроченной карте выдаётся при вводе даты 05/24 и ранее.
5. Ввод CVC - проверяется количество символов.
6. После ввода количества баллов и нажатия кнопки "Подтвердить" окно закрывается, баллы начисляются корректно.
7. Текущий рейтинг в модальном окне отображается корректно.
8. Форма позволяет повысить рейтинг с просроченной картой.

Удаление объявления. 

1. Удаление объявления происходит корректно.
